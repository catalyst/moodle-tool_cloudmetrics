...
$string['estimatedtaskload_summary'] = '{$a->duration} of estimated task load due in the next {$a->window}';
$string['estimatedtaskload_window'] = 'Estimating task load for the next {$a}.';
...
$string['two_days'] = '2 days';
$string['three_days'] = '3 days';
$string['four_days'] = '4 days';
...
$string['taskload_lookahead'] = 'Task load lookahead';
$string['taskload_lookahead_desc'] = 'How far ahead to estimate the scheduled and ad hoc task load. Defaults to 15 minutes.';
